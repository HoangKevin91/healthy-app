...
export default function ListCategory(props: Props) {
    const category = ["Morning", "Luch", "Dinner", "Snack"]
    return (
        <div className="flex mx-auto my-[25px] w-10/12">
            {category.map(x => {
                return (
                    <div className="w-1/4">
                        <div className="flex items-center justify-center flex-col bg-no-repeat bg-foodMenu-pattern bg-cover w-[134px] pt-[33px] pb-[33px]">
                            ...
                            <span className="text-xl text-white mt-1">{x}</span>
                        </div>
                    </div>
                )
            })}
